...
class UnionFindL(numBases: Long) extends UnionFindAbstract {
  ...
  val parentL = Array.fill(midPoint)(0)
  val parentH = Array.fill(midPoint)(0)
  ...
  val rankH = Array.fill(midPoint)(0)

  val clusterSizeL = Array.fill(midPoint)(0)
  val clusterSizeH = Array.fill(midPoint)(0)
  ...
  val firstMemberH = Array.fill(midPoint)(0)
