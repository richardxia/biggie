...
\bibitem{bamtools} Barnett D., Garrison E., Quinlan A., Str\"{o}mber M., and arth G., ``BamTools: a C++ API and toolkit for analyzing and managing BA files.'' {\em Bioinformatics} (2011), 27: 1691-1692.
...
\bibitem{samtools} Li H., Handsaker B., Wysoker A., Fennell T., Ruan J., Homer N., arth G., Abecasis G., Durbin R. and 1000 Genome Project Data Processing Subgroup, ``The Sequence alignment/map (SAM) format and SAMtools.'' {\em Bioinformatics} (2009), 25: 2078-9.
