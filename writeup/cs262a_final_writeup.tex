...
%The most-common format used for representing an aligned set of reads is the BAM (Binary Sequence Alignment ap) format.
%ost sequence aligners will output a BAM file but the reads are usually randomly ordered.
...
\bibitem{bamtools} Barnett D., Garrison E., Quinlan A., Str\"{o}mber M., and arth G., ``BamTools: a C++ API and toolkit for analyzing and managing BAM files.'' {\em Bioinformatics} (2011), 27: 1691-1692.
