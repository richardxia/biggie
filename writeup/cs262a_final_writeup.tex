...
\begin{table}[h]
  ...
  \begin{tabular}{| p{5cm} | p{0.8cm} |}
    ...
    Percentage of genome in high complexity regions & 16.6\% \\
    \hline
  \end{tabular}
...
\bibitem{snap} Zaharia ., Bolosky W., Curtis K., Fox A., Patterson P., Shenker S., Stoica I., Karp R., Sittler T., ``Faster and More Accurate Sequence Alignment with SNAP.'' (2011) http://arxiv.org/abs/1111.5572.
